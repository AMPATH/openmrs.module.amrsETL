...
insert into amrs_etl.etl_patient_demographics(
    patient_id,
    uuid,
    given_name,
    middle_name,
...
update amrs_etl.etl_patient_demographics d
left outer join
(
select
       pa.person_id,
...
insert into amrs_etl.etl_hiv_enrollment (
    patient_id,
    uuid,
    visit_id,
    visit_date,
...
select
       ...
       max(if(o.concept_id in (12127), o.value_coded, if(o.concept_id=160563 and o.value_coded=1065, 160563, null))) as patient_type ,
       max(if(o.concept_id=7013,o.value_datetime,null)) as date_first_enrolled_in_care ,
       ...
       max(if(o.concept_id=7015,left(trim(o.value_text),100),null)) as facility_transferred_tcingfrom,
       max(if(o.concept_id=161551,left(trim(o.value_text),100),null)) as district_transferred_from, -- *
       max(if(o.concept_id=2157,o.value_coded,null)) as previous_regimen,
       max(if(o.concept_id=159599,o.value_datetime,null)) as date_started_art_at_transferring_facility, -- *
       max(if(o.concept_id=9203,o.value_datetime,null)) as date_confirmed_hiv_positive,
       ...
       max(if(o.concept_id=7071,o.value_coded,null)) as relationship_of_treatment_supporter,
...
from amrs.encounter e
       inner join
         (
         select encounter_type_id, uuid, name from encounter_type where uuid='d2522122-4ea4-4a90-b23e-4f3e329144af'
       ...
       left outer join amrs.obs o on o.encounter_id=e.encounter_id and o.voided=0
                                  and o.concept_id in (12127, 7013, 7015, 2157, 9203, 5356, 7071)
where e.voided=0
...
INSERT INTO amrs_etl.etl_patient_hiv_followup(
uuid,
patient_id,
visit_id,
visit_date,
...
if(max(o.date_created) > min(e.date_created),max(o.date_created),NULL) as date_last_modified,
max(if(o.concept_id=1839,o.value_coded,null)) as visit_scheduled ,
...
max(if(o.concept_id=6171 and o.value_coded =159799,o.value_coded,null)) as cough,
max(if(o.concept_id=8065 and o.value_coded =1494,o.value_coded,null)) as fever,
max(if(o.concept_id=832 and o.value_coded =832,o.value_coded,null)) as weight_loss_poor_gain,
max(if(o.concept_id=8061 and o.value_coded =133027,o.value_coded,null)) as night_sweats,
...
max(if(o.concept_id=10239,o.value_coded,null)) as has_chronic_illnesses_cormobidities ,
max(if(o.concept_id=12249,o.value_coded,null)) as has_adverse_drug_reaction ,
max(if(o.concept_id=8351,o.value_coded,null)) as pregnancy_status,
max(if(o.concept_id=5632,o.value_coded,null)) as breastfeeding,
max(if(o.concept_id=11662,o.value_coded,null)) as wants_pregnancy,
max(if(o.concept_id=6224,o.value_coded,null)) as pregnancy_outcome,
...
max(if(o.concept_id=6496,o.value_coded,null)) as menopausal,
...
max(if(o.concept_id=7240,o.value_coded,null)) as family_planning_method,
max(if(o.concept_id=6687,o.value_coded,null)) as reason_not_using_family_planning ,
max(if(o.concept_id=8292,o.value_coded,null)) as tb_status,
...
max(if(o.concept_id=12,o.value_coded,null)) as chest_findings,
...
max(if(o.concept_id=6287,o.value_coded,null)) as condom_provided ,
max(if(o.concept_id=10835,o.value_coded,null)) as substance_abuse_screening ,
...
max(if(o.concept_id=9609,o.value_coded,null)) as sti_partner_notification,
max(if(o.concept_id=6578,o.value_coded,null)) as at_risk_population,
...
max(if(o.concept_id=7413,o.value_coded,null)) as differentiated_care,
max(if(o.concept_id=6266,o.value_coded,null)) as insurance_type,
max(if(o.concept_id=6266,o.value_text,null)) as other_insurance_specify,
max(if(o.concept_id=165911,o.value_coded,null)) as insurance_status, -- *
e.voided as voided
from amrs.encounter e
	inner join amrs.person p on p.person_id=e.patient_id and p.voided=0
inner join form f on f.form_id = e.form_id and f.uuid in ('0a7083ab-90e5-413d-ba5f-5fcd060d19dd')
left outer join amrs.obs o on o.encounter_id=e.encounter_id and o.voided=0
	and o.concept_id in (1839, 5089, 5085, 5086, 5090, 5088, 5087, 1343, 164930, 5356, 164950, 1729, 6171,8065, 832, 8061, 307, 12, 1932, 10239, 12249, 8351, 5632, 11662, 6224, 5596, 6496, 1823, 7240, 6687, 8292, 6287, 10835, 6578, 7413, 6266)
where e.voided=0
...
insert into amrs_etl.etl_laboratory_extract(
uuid,
encounter_id,
patient_id,
location_id,
...
insert into amrs_etl.etl_pharmacy_extract(
obs_group_id,
patient_id,
uuid,
visit_date,
...
update amrs_etl.etl_pharmacy_extract
...
insert into amrs_etl.etl_patient_program_discontinuation(
patient_id,
uuid,
visit_id,
visit_date,
...
CREATE PROCEDURE sp_populate_etl_mch_enrollment()
	BEGIN
		...
		insert into amrs_etl.etl_mch_enrollment(
			patient_id,
			uuid,
			visit_id,
			visit_date,
...
CREATE PROCEDURE sp_populate_etl_mch_antenatal_visit()
	BEGIN
		...
		insert into amrs_etl.etl_mch_antenatal_visit(
			patient_id,
			uuid,
			visit_id,
			visit_date,
...
CREATE PROCEDURE sp_populate_etl_mch_delivery()
	BEGIN
		...
		insert into amrs_etl.etl_mchs_delivery(
			patient_id,
			uuid,
			provider,
			visit_id,
...
CREATE PROCEDURE sp_populate_etl_mch_discharge()
	BEGIN
		...
		insert into amrs_etl.etl_mchs_discharge(
			patient_id,
			uuid,
			provider,
			visit_id,
...
CREATE PROCEDURE sp_populate_etl_mch_postnatal_visit()
	BEGIN
		...
		insert into amrs_etl.etl_mch_postnatal_visit(
			patient_id,
			uuid,
			visit_id,
			visit_date,
...
CREATE PROCEDURE sp_populate_etl_hei_enrolment()
	BEGIN
		...
		insert into amrs_etl.etl_hei_enrollment(
			patient_id,
			uuid,
			provider,
			visit_id,
...
CREATE PROCEDURE sp_populate_etl_hei_follow_up()
	BEGIN
		...
		insert into amrs_etl.etl_hei_follow_up_visit(
			patient_id,
			uuid,
			provider,
			visit_id,
...
CREATE PROCEDURE sp_populate_etl_hei_immunization()
 BEGIN
  SELECT "Processing hei_immunization data ", CONCAT("Time: ", NOW());
    insert into amrs_etl.etl_hei_immunization(
    patient_id,
    visit_date,
    created_by,
    date_created,
...
insert into amrs_etl.etl_tb_enrollment(
patient_id,
uuid,
provider,
visit_id,
...
insert into amrs_etl.etl_tb_follow_up_visit(
patient_id,
uuid,
provider,
visit_id ,
...
insert into amrs_etl.etl_tb_screening(
    patient_id,
    uuid,
    provider,
    visit_id,
...
SELECT "Processing Drug Event Data", CONCAT("Time: ", NOW());
	INSERT INTO amrs_etl.etl_drug_event(
		uuid,
		patient_id,
		date_started,
		visit_date,
...
INSERT INTO amrs_etl.etl_hts_test (
patient_id,
visit_id,
encounter_id,
encounter_uuid,
...
INSERT INTO amrs_etl.etl_hts_referral_and_linkage (
  patient_id,
  visit_id,
  encounter_id,
  encounter_uuid,
...
CREATE PROCEDURE sp_populate_hts_referral()
  BEGIN
    ...
    INSERT INTO amrs_etl.etl_hts_referral (
      patient_id,
      visit_id,
      encounter_id,
      encounter_uuid,
...
-- CURRENT IN CARE
DROP TABLE IF EXISTS amrs_etl.etl_current_in_care;

CREATE TABLE amrs_etl.etl_current_in_care AS
	...
	from amrs_etl.etl_patient_hiv_followup fup
		join amrs_etl.etl_patient_demographics p on p.patient_id=fup.patient_id
		join amrs_etl.etl_hiv_enrollment e on fup.patient_id=e.patient_id
		left outer join amrs_etl.etl_drug_event de on e.patient_id = de.patient_id and de.program='HIV' and date(date_started) <= date(endDate)
		left outer JOIN
		(select patient_id, coalesce(date(effective_discontinuation_date),visit_date) visit_date,max(date(effective_discontinuation_date)) as effective_disc_date from amrs_etl.etl_patient_program_discontinuation
...
-- ADD INDICES
ALTER TABLE amrs_etl.etl_current_in_care ADD INDEX(enroll_date);
ALTER TABLE amrs_etl.etl_current_in_care ADD INDEX(latest_vis_date);
ALTER TABLE amrs_etl.etl_current_in_care ADD INDEX(latest_tca);
ALTER TABLE amrs_etl.etl_current_in_care ADD INDEX(started_on_drugs);
ALTER TABLE amrs_etl.etl_current_in_care ADD INDEX(patient_id);


DROP TABLE IF EXISTS amrs_etl.etl_last_month_newly_enrolled_in_care;
CREATE TABLE amrs_etl.etl_last_month_newly_enrolled_in_care (
  patient_id INT(11) not null
);

INSERT INTO amrs_etl.etl_last_month_newly_enrolled_in_care
select distinct e.patient_id
from amrs_etl.etl_hiv_enrollment e
       join amrs_etl.etl_patient_demographics p on p.patient_id=e.patient_id
...
DROP TABLE IF EXISTS amrs_etl.etl_last_month_newly_on_art;
CREATE TABLE amrs_etl.etl_last_month_newly_on_art (
  patient_id INT(11) not null
);

INSERT INTO amrs_etl.etl_last_month_newly_on_art
...
from (
     ...
     from (select e.patient_id,p.dob,p.Gender,min(e.date_started) as date_started,
           ...
           from amrs_etl.etl_drug_event e
                  join amrs_etl.etl_patient_demographics p on p.patient_id=e.patient_id
           group by e.patient_id) e
            left outer join amrs_etl.etl_patient_program_discontinuation d on d.patient_id=e.patient_id
            left outer join amrs_etl.etl_hiv_enrollment enr on enr.patient_id=e.patient_id
            left outer join amrs_etl.etl_patient_hiv_followup fup on fup.patient_id=e.patient_id
...
TRUNCATE TABLE amrs_etl.etl_patients_booked_today;
ALTER TABLE amrs_etl.etl_patients_booked_today AUTO_INCREMENT = 1;

INSERT INTO amrs_etl.etl_patients_booked_today(patient_id, last_visit_date)
SELECT patient_id, visit_date FROM amrs_etl.etl_patient_hiv_followup
GROUP BY patient_id HAVING max(date(next_appointment_date)) = CURDATE();

-- Viral load tracker
DROP TABLE IF EXISTS amrs_etl.etl_viral_load_tracker;

CREATE TABLE amrs_etl.etl_viral_load_tracker (
  patient_id INT(11) not null,
  vl_date DATE,
...
insert into amrs_etl.etl_viral_load_tracker
...
join amrs_etl.etl_patient_demographics p on p.patient_id=fup.patient_id
join amrs_etl.etl_hiv_enrollment e on fup.patient_id=e.patient_id
left join amrs_etl.etl_drug_event de on e.patient_id = de.patient_id and de.program='HIV' and date(date_started) <= date(curdate())
left outer JOIN
(select patient_id, coalesce(date(effective_discontinuation_date),visit_date) visit_date,max(date(effective_discontinuation_date)) as effective_disc_date from amrs_etl.etl_patient_program_discontinuation
...
from amrs_etl.etl_laboratory_extract
group by patient_id
...
-- Tested contacts
DROP TABLE IF EXISTS amrs_etl.etl_hts_contacts;

CREATE TABLE amrs_etl.etl_hts_contacts AS
...
amrs_etl.etl_patient_contact c inner join amrs_etl.etl_hts_test t on c.patient_id = t.patient_id group by c.patient_id;

ALTER TABLE amrs_etl.etl_hts_contacts ADD INDEX(id);
ALTER TABLE amrs_etl.etl_hts_contacts ADD INDEX(patient_id);
ALTER TABLE amrs_etl.etl_hts_contacts ADD INDEX(visit_date);

-- Linked contacts
DROP TABLE IF EXISTS amrs_etl.etl_contacts_linked;

CREATE TABLE amrs_etl.etl_contacts_linked AS
select c.id,c.patient_id,c.relationship_type,c.baseline_hiv_status,l.visit_date,t.final_test_result from amrs_etl.etl_patient_contact c inner join amrs_etl.etl_hts_test t on c.patient_id = t.patient_id
inner join amrs_etl.etl_hts_referral_and_linkage l on c.patient_id=l.patient_id
group by c.id;

ALTER TABLE amrs_etl.etl_contacts_linked ADD INDEX(id);
ALTER TABLE amrs_etl.etl_contacts_linked ADD INDEX(visit_date);
...
insert into amrs_etl.etl_ipt_screening(
uuid,
provider,
patient_id,
visit_id,
...
insert into amrs_etl.etl_ipt_follow_up(
patient_id,
uuid,
provider,
visit_id,
...
insert into amrs_etl.etl_ccc_defaulter_tracing(
uuid,
provider,
patient_id,
visit_id,
...
max(if(o.concept_id=1592,date(o.value_datetime),null)) as missed_appointment_date,
max(if(o.concept_id = 10350, o.value_coded, null )) as reason_for_missed_appointment,
max(if(o.concept_id = 163513, o.value_text, "" )) as non_coded_missed_appointment_reason, -- *
max(if(o.concept_id = 10995, o.value_coded, null )) as tracing_outcome,
max(if(o.concept_id = 9069, o.value_coded, null )) as reason_not_contacted,
max(if(o.concept_id = 10994, value_numeric, "" )) as attempt_number,
max(if(o.concept_id = 163725, o.value_coded, "" )) as is_final_trace,
max(if(o.concept_id = 160433, o.value_coded, "" )) as true_status,
max(if(o.concept_id = 1573, o.value_coded, "" )) as cause_of_death,
max(if(o.concept_id = 9467, o.value_text, "" )) as comments,
max(if(o.concept_id=163526,date(o.value_datetime),null)) as booking_date, -- *
e.date_created as date_created,
if(max(o.date_created) > min(e.date_created),max(o.date_created),NULL) as date_last_modified
from amrs.encounter e
	inner join amrs.person p on p.person_id=e.patient_id and p.voided=0
	inner join amrs.form f on f.form_id=e.form_id and f.uuid in ("f3ba9242-9bbb-4284-a0c0-56ac6f0cec65")
inner join amrs.obs o on o.encounter_id = e.encounter_id and o.concept_id in (163725,160433,1573,9467,163526,164966,1592,10350,163513,10995,9069,10994) and o.voided=0
where e.voided=0
group by e.encounter_id;
...
CREATE PROCEDURE sp_populate_etl_ART_preparation()
  BEGIN
    ...
    insert into amrs_etl.etl_ART_preparation(
...
CREATE PROCEDURE sp_populate_etl_enhanced_adherence()
	BEGIN
		...
		insert into amrs_etl.etl_enhanced_adherence(
			uuid,
			patient_id,
			visit_id,
			visit_date,
...
CREATE PROCEDURE sp_populate_etl_patient_triage()
	BEGIN
		...
		INSERT INTO amrs_etl.etl_patient_triage(
			uuid,
			patient_id,
			visit_id,
			visit_date,
...
CREATE PROCEDURE sp_populate_etl_generalized_anxiety_disorder()
  BEGIN
    ...
    insert into amrs_etl.etl_generalized_anxiety_disorder(
			uuid,
			patient_id,
			visit_id,
			visit_date,
...
CREATE PROCEDURE sp_populate_etl_prep_behaviour_risk_assessment()
  BEGIN
    ...
    insert into amrs_etl.etl_prep_behaviour_risk_assessment(
        uuid,
        provider,
        patient_id,
        visit_id,
...
CREATE PROCEDURE sp_populate_etl_prep_monthly_refill()
  BEGIN
    ...
    insert into amrs_etl.etl_prep_monthly_refill(
        uuid,
        provider,
        patient_id,
        visit_id,
...
CREATE PROCEDURE sp_populate_etl_prep_discontinuation()
  BEGIN
    ...
    insert into amrs_etl.etl_prep_discontinuation(
        uuid,
        provider,
        patient_id,
        visit_id,
...
CREATE PROCEDURE sp_populate_etl_prep_enrolment()
  BEGIN
    ...
    insert into amrs_etl.etl_prep_enrolment(
        uuid,
        provider,
        patient_id,
        visit_id,
...
CREATE PROCEDURE sp_populate_etl_prep_followup()
  BEGIN
    ...
    insert into amrs_etl.etl_prep_followup(
        uuid,
        form,
        provider,
        patient_id,
...
CREATE PROCEDURE sp_populate_etl_progress_note()
  BEGIN
    ...
    insert into amrs_etl.etl_progress_note(
        uuid,
        provider ,
        patient_id,
        visit_id,
...
CREATE PROCEDURE sp_populate_etl_ipt_initiation()
	BEGIN
		...
		insert into amrs_etl.etl_ipt_initiation(
			patient_id,
			uuid,
			encounter_provider,
			visit_date ,
...
update amrs_etl.etl_ipt_initiation i
join (select pi.patient_id,
...
CREATE PROCEDURE sp_populate_etl_ipt_outcome()
	BEGIN
		...
		insert into amrs_etl.etl_ipt_outcome(
			patient_id,
			uuid,
			encounter_provider,
			visit_date ,
...
CREATE PROCEDURE sp_populate_etl_hts_linkage_tracing()
	BEGIN
		...
		INSERT INTO amrs_etl.etl_hts_linkage_tracing(
			uuid,
			patient_id,
			visit_date,
			location_id,
...
CREATE PROCEDURE sp_populate_etl_patient_program()
	BEGIN
		...
		INSERT INTO amrs_etl.etl_patient_program(
			uuid,
			patient_id,
			location_id,
			program,
...
CREATE PROCEDURE sp_populate_etl_person_address()
  BEGIN
    ...
    INSERT INTO amrs_etl.etl_person_address(
      uuid,
      patient_id,
      county,
      sub_county,
...
CREATE PROCEDURE sp_populate_etl_otz_enrollment()
	BEGIN
		...
		INSERT INTO amrs_etl.etl_otz_enrollment(
			uuid,
			patient_id,
			visit_date,
			location_id,
...
CREATE PROCEDURE sp_populate_etl_otz_activity()
	BEGIN
		...
		INSERT INTO amrs_etl.etl_otz_activity(
			uuid,
			patient_id,
			visit_date,
			visit_id,
...
CREATE PROCEDURE sp_create_default_facility_table()
	BEGIN
		...
		CREATE TABLE amrs_etl.etl_default_facility_info
...
CREATE PROCEDURE sp_populate_etl_ovc_enrolment()
    ...
    INSERT INTO amrs_etl.etl_ovc_enrolment(
        uuid,
        patient_id,
        visit_date,
        location_id,
...
insert into amrs_etl.etl_cervical_cancer_screening(
    uuid,
    encounter_id,
    encounter_provider,
    patient_id,
...
CREATE PROCEDURE sp_populate_etl_patient_contact()
	BEGIN
		...
		INSERT INTO amrs_etl.etl_patient_contact(
      id,
      uuid,
      date_created,
      date_last_modified,
      ...
      voided
        ...
        pc.voided
			from kenyaemr_hiv_testing_patient_contact pc
				inner join amrs_etl.etl_patient_demographics dm on dm.patient_id=pc.patient_related_to and dm.voided=0
        where pc.voided=0
		;
...
CREATE PROCEDURE sp_populate_etl_client_trace()
	BEGIN
		...
		INSERT INTO amrs_etl.etl_client_trace(
      id,
      uuid,
      date_created,
      date_last_modified,
      ...
      voided
        ...
        ct.voided
			from kenyaemr_hiv_testing_client_trace ct
				...
				inner join amrs_etl.etl_patient_contact pc on pc.id=ct.client_id and ct.voided=0
        where pc.voided=0
		;
    ...
    CREATE PROCEDURE sp_populate_etl_kp_contact()
      BEGIN
        ...
        insert into amrs_etl.etl_contact (
            uuid,
            client_id,
            visit_id,
            visit_date,
    ...
    insert into amrs_etl.etl_client_enrollment (
        uuid,
        client_id,
        visit_id,
        visit_date,
    ...
    CREATE PROCEDURE sp_populate_etl_kp_clinical_visit()
      BEGIN
        ...
        INSERT INTO amrs_etl.etl_clinical_visit(
            uuid,
            client_id,
            visit_id,
            visit_date,
    ...
    -- ------------- populate etl_kp_sti_treatment--------------------------------
        ...
        CREATE PROCEDURE sp_populate_etl_kp_sti_treatment()
          BEGIN
            ...
            INSERT INTO amrs_etl.etl_sti_treatment(
                uuid,
                client_id,
                visit_id,
                visit_date,
    ...
    -- ------------- populate etl_kp_peer_calendar--------------------------------
        ...
        CREATE PROCEDURE sp_populate_etl_kp_peer_calendar()
          BEGIN
            ...
            INSERT INTO  amrs_etl.etl_peer_calendar(
                uuid,
                client_id,
                visit_id,
                visit_date,
...
insert into amrs_etl.etl_peer_tracking(
uuid,
provider,
client_id,
visit_id,
...
insert into amrs_etl.etl_treatment_verification(
uuid,
provider,
client_id,
visit_id,
...
insert into amrs_etl.etl_gender_based_violence(
uuid,
provider,
client_id,
visit_id,
...
insert into amrs_etl.etl_PrEP_verification(
uuid,
provider,
client_id,
visit_id,
...
insert into amrs_etl.etl_alcohol_drug_abuse_screening(
patient_id,
uuid,
provider,
visit_id,
...
insert into amrs_etl.etl_gbv_screening(
uuid,
provider,
patient_id,
visit_id,
...
insert into amrs_etl.etl_gbv_screening_action(
    uuid,
    provider,
    patient_id,
    encounter_id,
...
insert into amrs_etl.etl_violence_reporting(
uuid,
provider,
patient_id,
visit_id,
...
insert into amrs_etl.etl_link_facility_tracking(
uuid,
provider,
patient_id,
visit_id,
...
insert into amrs_etl.etl_depression_screening(
uuid,
provider,
patient_id,
visit_id,
...
insert into amrs_etl.etl_adverse_events(
    uuid ,
    form,
    provider,
    patient_id,
...
insert into amrs_etl.etl_allergy_chronic_illness(
uuid,
provider,
patient_id,
visit_id,
...
insert into amrs_etl.etl_pre_hiv_enrollment_art(
    uuid,
    provider,
    patient_id,
    visit_id,
...
insert into amrs_etl.etl_covid19_assessment (uuid,
                                                 provider,
                                                 patient_id,
                                                 visit_id,
                                                 visit_date,
...
BEGIN
    ...
    insert into amrs_etl.etl_vmmc_enrolment(
        uuid,
        provider,
        patient_id,
        visit_id,
    ...
    BEGIN
        ...
        insert into amrs_etl.etl_vmmc_circumcision_procedure(
            uuid,
            provider,
            patient_id,
            visit_id,
...
CREATE PROCEDURE sp_populate_etl_vmmc_client_followup()
  BEGIN
    ...
    insert into amrs_etl.etl_vmmc_client_followup(
      uuid,
      provider,
      patient_id,
      visit_id,
    ...
    BEGIN
        ...
        insert into amrs_etl.etl_vmmc_medical_history(
            uuid,
            provider,
            patient_id,
            visit_id,
    ...
    BEGIN
        ...
        insert into amrs_etl.etl_vmmc_post_operation_assessment(uuid,
                                                                    provider,
                                                                    patient_id,
                                                                    visit_id,
                                                                    visit_date,
...
CREATE PROCEDURE sp_populate_etl_hts_eligibility_screening()
  BEGIN
    ...
    INSERT INTO amrs_etl.etl_hts_eligibility_screening (
      patient_id,
      visit_id,
      encounter_id,
      uuid,
...
BEGIN
    INSERT INTO amrs_etl.etl_drug_order (
        uuid,
        encounter_id,
        order_group_id,
        patient_id,
...
BEGIN
    insert into amrs_etl.etl_preventive_services(
        patient_id,
        visit_date,
        provider,
        location_id,
...
BEGIN
    ...
    INSERT INTO amrs_etl.etl_overdose_reporting (
        client_id,
        visit_id,
        encounter_id,
        uuid,
...
BEGIN
  ...
  INSERT INTO amrs_etl.etl_patient_appointment(patient_appointment_id, 
  provider_id, 
  patient_id, 
  visit_date, 
  start_date_time, 
...
BEGIN
  ...
  update amrs_etl.etl_patient_hiv_followup fup
    inner join amrs_etl.etl_patient_appointment pat on pat.patient_id = fup.patient_id and pat.visit_date = fup.visit_date and pat.appointment_service_id = 1
set fup.next_appointment_date = date(pat.start_date_time) where fup.patient_id > 0;

 update amrs_etl.etl_patient_hiv_followup fup
    inner join amrs_etl.etl_patient_appointment pat on pat.patient_id = fup.patient_id and pat.visit_date = fup.visit_date and pat.appointment_service_id = 2
set fup.refill_date = date(pat.start_date_time) where fup.patient_id > 0;

update amrs_etl.etl_prep_followup fup
    inner join amrs_etl.etl_patient_appointment pat on pat.patient_id = fup.patient_id and pat.visit_date = fup.visit_date and pat.appointment_service_id = 8
set fup.appointment_date = date(pat.start_date_time) where fup.patient_id > 0;

update amrs_etl.etl_prep_monthly_refill fup
    inner join amrs_etl.etl_patient_appointment pat on pat.patient_id = fup.patient_id and pat.visit_date = fup.visit_date and pat.appointment_service_id = 9
set fup.next_appointment = date(pat.start_date_time) where fup.patient_id > 0;

update amrs_etl.etl_tb_follow_up_visit fup
    inner join amrs_etl.etl_patient_appointment pat on pat.patient_id = fup.patient_id and pat.visit_date = fup.visit_date and pat.appointment_service_id = 6
set fup.next_appointment_date = date(pat.start_date_time) where fup.patient_id > 0;

update amrs_etl.etl_clinical_visit fup
    inner join amrs_etl.etl_patient_appointment pat on pat.patient_id = fup.client_id and pat.visit_date = fup.visit_date and pat.appointment_service_id = 3
set fup.appointment_date = date(pat.start_date_time) where fup.client_id > 0;

update amrs_etl.etl_mch_antenatal_visit fup
    inner join amrs_etl.etl_patient_appointment pat on pat.patient_id = fup.patient_id and pat.visit_date = fup.visit_date and pat.appointment_service_id = 4
set fup.next_appointment_date = date(pat.start_date_time) where fup.patient_id > 0;

update amrs_etl.etl_mch_postnatal_visit fup
    inner join amrs_etl.etl_patient_appointment pat on pat.patient_id = fup.patient_id and pat.visit_date = fup.visit_date and pat.appointment_service_id = 5
set fup.appointment_date = date(pat.start_date_time) where fup.patient_id > 0;

update amrs_etl.etl_hei_follow_up_visit fup
    inner join amrs_etl.etl_patient_appointment pat on pat.patient_id = fup.patient_id and pat.visit_date = fup.visit_date and pat.appointment_service_id = 13
set fup.next_appointment_date = date(pat.start_date_time) where fup.patient_id > 0;
...
BEGIN
    ...
    INSERT INTO amrs_etl.etl_art_fast_track (uuid,
             provider,
             patient_id,
             visit_id,
             visit_date,
...
BEGIN
    ...
    INSERT INTO amrs_etl.etl_clinical_encounter (
        patient_id,
        visit_id,
        encounter_id,
        uuid,
...
BEGIN
	...
	INSERT INTO amrs_etl.etl_daily_revenue_summary (
		transaction_date,
		total_sales,
		ipd_cash,
		maternity,
...
INSERT INTO amrs_etl.etl_script_status(script_name, start_time) VALUES('initial_population_of_tables', NOW());
...
UPDATE amrs_etl.etl_script_status SET stop_time=NOW() where id= populate_script_id;
